...
This repository addresses consent enforcement, authorization, integrity logging, policy evaluation, and accountability. Unless a release states otherwise with reproducible evidence, its components are research, prototype, documentation, or simulation artifacts and are not approved for safety-critical production use.

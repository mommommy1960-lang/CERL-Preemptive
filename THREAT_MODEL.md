...
This repository covers consent enforcement, authorization, integrity logging, policy evaluation, and accountability. This document establishes a baseline and must be revised as architecture and evidence change.
